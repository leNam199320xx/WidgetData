...
public class WidgetService : IWidgetService
{
    ...
    public WidgetService(IWidgetCrudService crud, IWidgetExecutionService execution)
    {
        _crud = crud;
        ...
        IHttpClientFactory httpClientFactory, ITenantContext? tenantContext = null)
    {
        ...
        _execution = new WidgetExecutionService(widgetRepo, executionRepo, archiveRepo, scheduleRepo, auditService, logger, httpClientFactory,
            new IDataSourceStrategy[] { new CsvDataSourceStrategy(), new JsonDataSourceStrategy(), new ExcelDataSourceStrategy(), new RestApiDataSourceStrategy() },
            tenantContext);
    }
